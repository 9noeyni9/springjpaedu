...
public class MemberTeamTest1 {
	...
	public static void main(String[] args) {
        ...
        Team t1 = new Team("1팀", "아기공룡둘리");//team 생성
        Team t2 = new Team("2팀", "겨울왕국");
        Team t3 = new Team("3팀", "짱구는못말려");
        
        em.persist(t1);//생성한 team 저장 
        em.persist(t2);
        em.persist(t3);
        
        Member m1 = new Member("둘리", t1);//저장한 team에 멤버 추가
        ...
        em.getTransaction().commit();//변경사항 반영       
        em.close();
        factory.close();
	}
}
